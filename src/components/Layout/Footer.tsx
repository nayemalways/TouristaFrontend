    ...
    <footer className="bg-background">
      <div className="mx-auto container space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="text-foreground w-38 max-md:24">
               <Logo/>
            </div>
            <p className="mt-4 max-w-xs text-muted-foreground">
              We are simplifies travel planning by organizing tours, bookings, destinations, and customer details in one place.
            </p>
